    ...
    <motion.div
      ...
      <LampContainer>
        ...
        <motion.h3
          ...
          className="mt-0 bg-gradient-to-br from-slate-300 to-slate-500 py-2 bg-clip-text text-center text-2xl font-medium tracking-tight text-transparent md:text-5xl">
